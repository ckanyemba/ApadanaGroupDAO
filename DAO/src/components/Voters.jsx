...
const Voters = () => {
  ...
  const deactive = `bg-transparent
    text-blue-600 fornt-medium text-xs leading-tight
  ...
  const active = `bg-blue-600
    ...
    uppercase hover:bg-blue-700 focus:bg-blue-800
    transition duration-150 ease-in-out overflow-hidden
  ...
  return (
    <div className="flex flex-col p-8">
      ...
      <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="py-2 inline-block min-w-wfull sm:px-6 lg:px-8">
        ...
        {voters.length >= 10 ? (
          <button
            ...
            className="rounded-full px-6 py-2.5 bg-blue-600
                ...
                transition duration-150 ease-in-out dark:text-gray-300 dark:border 
