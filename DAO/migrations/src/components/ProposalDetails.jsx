...
import { useGlobal, daysRemaining, useGlobalState } from "../store";
  ...
  useEffect(() => {
    ...
    return (
      <div className="p-8">
        ...
        <p>
          This proposal is to payout <strong>{proposal?.title}</strong> and
          currently have{" "}
        ...
        <div className="flex flex-row justify-start items-center w-full mt-4 overflow-auto">
            <BarChart witdth={730} height={250} data={data}>
                ...
                {isStakeholder ? (
                    <>
                        <button
                            ...
                            hover:bg-blue-700 focus:outline-none focus:ring:0
