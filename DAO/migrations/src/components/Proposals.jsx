...
const Proposals = () => {
  ...
  const deactive = `bg-transparent
    ...
    uppercase hover:outline-none focus:ring-0 active:bg-blue-600
    transition duration-150 ease-in-out overflow-hidden
    border border-blue-600 hover:text-white focus:text-white`;

  const active = `bg-blue-600 text-white font-medium text-xs leading-tight
    uppercase hover:bg-blue-700 focus:ring-0 active:bg-blue-800 transition
    duration-150 ease-in-out overflow-hidden border border-blue-600`;
  ...
  return (
    <div className="flex flex-col p-8">
      <div className="flex flex-row justify-center items-center" role="group">
        <button
          aria-current="page"
          className={`rounded-1-full px-6 py-2.5 ${active}`}
          onClick={getAll}
        >
          All
        </button>
      ...
      <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
          <div className="h-[calc(100vh_-20rem)] overflow-y-auto shadow-md rounded-md">
                  ...
                  >
                    ...
                    >
                      <Link
                        ...
                        uppoercase hover:border-blue-700 focus:border-blue-700
                      ...
                      Number(proposal.duration + "000") ? (
                        proposal.upvotes > proposal.downvotes ? (
                          ...
                          <button
                            className="dark:border rounded-full px-6 py-2.5 dark:border-red-600
                            dark:text-red-600 dark:bg-transparent font-medium text-xs leading-tight
                            uppercase hover:border-red-700 focus:outline-none focus:ring-0 active:border-red-800
                            transition duration-150 ease-in-out text-white bg-red-600"
                          >
                            Rejected
                          </button>
