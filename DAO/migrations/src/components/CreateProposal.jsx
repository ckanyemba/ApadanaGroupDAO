...
const CreateProposal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    toast.success("Proposal created, reloading in process...");
    closeModal();
  };
  ...
  return (
    <div className={`fixed top-0 left-0 w-screen flex items-center justify-center bg-black bg-opacity-50 transform z-50 transition-transform duration-300 ${createModal}`}>
